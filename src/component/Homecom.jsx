...
const Homecom = () => {
  ...
  <div className='absolute w-[97%] m-7 -mb-10'>
      <div className=' p-4 pr-10 pb-10 h-screen'>

        <p className=' text-right ml-4 text-stone-50 font-semibold text-[1.0rem] font-serif [text-shadow:_0_2px_0_rgb(0_0_0_/_30%)]'>The Creation of Adam</p>
        <div className='text-left ml-7 mt-6 absolute'>
            ...
            <p className='absolute  text-[2.8rem] -mt-7 bg-gradient-to-b from-amber-200 to-amber-800 bg-clip-text text-transparent italic font-semibold'>Software Tester / Front end Devoloper</p>

        </div>

        <div className='flex flex-col-reverse  mt-10 h-[87%]'>
        <p className='absolute text-left ml-7 text-stone-50 font-serif font-semibold text-[1.0rem] [text-shadow:_0_2px_0_rgb(0_0_0_/_30%)]'>Creazione di Adamo / Michelangelo</p>
